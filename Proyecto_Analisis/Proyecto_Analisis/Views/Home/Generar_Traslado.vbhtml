...
<form action="../Home/Agregar_Traslado_Generadoo" method="post">


    <div class="form-row ">
        <div class="form-group col-md-6">
            <input type="text" class="form-control" name="detras_cantidad" placeholder="Cantidad">
        </div>
        ...
        <div Class="col-md-4 mb-3">
            ...
            <div Class="col-md-4 mb-3">
                @Html.DropDownList("id_tras", New SelectList(Model.trasladoList, "Value", "Text"), "Traslado")
            </div>
